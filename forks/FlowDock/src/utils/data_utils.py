...
from src.data.components.process_mols import read_molecule

rootutils.setup_root(__file__, indicator=".project-root", pythonpath=True)

from src.data.components import residue_constants
from src.data.components.mol_features import (
    attach_pair_idx_and_encodings,
    collate_numpy_samples,
    process_mol_file,
)
from src.data.components.residue_constants import restype_1to3 as af_restype_1to3
from src.data.components.residue_constants import restypes as af_restypes
from src.models.components.transforms import LatentCoordinateConverter
