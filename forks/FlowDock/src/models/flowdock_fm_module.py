...
from src.utils.model_utils import extract_esm_embeddings
...
from src.utils.data_utils import pdb_filepath_to_protein, prepare_batch
from src.utils.sampling_utils import multi_pose_sampling
...
class FlowDockFMLitModule(LightningModule):
    ...
    def model_step(
        ...
        return eval_structure_prediction_losses(
            self, batch, batch_idx, self.device, stage, t_1=1.0
        )
