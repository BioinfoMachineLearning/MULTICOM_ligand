...
from multicom_ligand.utils.data_utils import extract_protein_and_ligands_with_prody
...
def main(cfg: DictConfig):
    ...
    assert cfg.dataset in [
        ...
        "casp15",
        "ensemble",
    ], "Dataset must be one of 'posebusters_benchmark', 'astex_diverse', 'dockgen', 'casp15', 'ensemble'."
